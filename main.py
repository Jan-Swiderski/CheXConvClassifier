...
parser_train.add_argument('-o', '--optim_config', type=str, default="./configs/optimizer_config.json", help="Path to the optimizer's config JSON. Use only in 'train' mode.")
parser_train.add_argument('-p', '--hyperparams', type=str, default="./configs/hyperparams_config.json", help="Path to the hyperparameters config JSON for training, validation, or testing.")
...
parser_test = subparsers.add_parser("test", help="Model training mode.", formatter_class=argparse.ArgumentDefaultsHelpFormatter)
